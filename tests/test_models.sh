...
do
  asreview simulate synergy:${DATASET} -q $qs --seed 535 --prior_seed 535 -s ${DATASET}_${qs}.asreview
...
do
  asreview simulate synergy:${DATASET} -q $bs --seed 535 --prior_seed 535 -s ${DATASET}_${bs}.asreview
...
for m in "${MODELS[@]}"
do
  asreview simulate synergy:${DATASET} -q $m --seed 535 --prior_seed 535 -s ${DATASET}_${m}.asreview
...
do
  asreview simulate synergy:${DATASET} -q $fs --seed 535 --prior_seed 535 -s ${DATASET}_${fs}.asreview
