...
and winner of the *KNVI-Victorine van Schaickfonds Initiative Award*,
...
[Rreadthedocs.io/](https://asreview.readthedocs.io/) and have a look at the
[quick tour](https://asreview.readthedocs.io/en/latest/lab/overview_lab.html)
for a *quick tour* through the user interface. 

## Citation

The publication in **Nature Machine
Intelligence**(https://doi.org/10.1038/s42256-020-00287-7) can be used to cite
the project. For citing the software, please refer to the specific release of
the ASReview software on Zenodo
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3345592.svg)](https://doi.org/10.5281/zenodo.3345592).
The menu on the right can be used to find the citation format of prevalence.
...
started [here
:arrow_left:](https://github.com/asreview/asreview/blob/master/CONTRIBUTING.md).
See who have contributed to ASReview
[here](https://github.com/asreview/asreview/blob/master/CONTRIBUTORS.md). For
any questions or remarks, please send an email to asreview@uu.nl.
