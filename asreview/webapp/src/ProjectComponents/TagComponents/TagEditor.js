  ...
  return (
    <Dialog open={props.open} onClose={handleClose}>
        ...
        <Stack spacing={3}>
          ...
          <Stack direction="row" spacing={3}>
            ...
            <TextField
              ...
              id="tag-id"
              label="Id"
              helperText={duplicatedId ? "Tag Ids must be unique within the category" : " "}
              value={id}
      ...
      <DialogActions>
        ...
        <Button onClick={addClicked} disabled={name === "" || id === "" || duplicatedId}>
          Add
        </Button>
      </DialogActions>
    </Dialog>
  ...
  return (
    <Dialog open={props.open} onClose={handleClose}>
      ...
      <DialogContent>
        <DialogContentText>{props.contentText}</DialogContentText>
        <Stack spacing={3}>
          <TypographySubtitle1Medium>Category Details</TypographySubtitle1Medium>
          <Stack direction="row" spacing={3}>
            <TextField
              fullWidth
              id="category-name"
            ...
            <TextField
              ...
              helperText={duplicatedCategoryId ? "Category Ids must be unique" : " "}
            />
          </Stack>
        </Stack>
        <Stack spacing={3}>
      ...
      <DialogActions>
        <Button onClick={handleClose}>Cancel</Button>
        <Button onClick={addClicked} disabled={name === "" || id === "" || !tagsValid  || !tagsUnique}>
          Create Category
        </Button>
      </DialogActions>
    </Dialog>
