...
class BaseReview(ABC):
    ...
    def settings(self):
        ...
        return ASReviewSettings(
            ...
            n_instances=self.n_instances, n_queries=self.n_queries,
            n_papers=self.n_papers, n_prior_included=n_prior_included,
            n_prior_excluded=n_prior_excluded, model_param=self.model.param,
