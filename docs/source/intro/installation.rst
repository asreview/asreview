...
Temove ASReview from your pc with

.. code:: bash

    pip uninstall asreview

You will be aksed whether you would like to proceed, click ``yes``. 

.. warning::

    Note that your project files will ``not`` be deleted with this action.
