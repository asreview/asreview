...
for simulations<../API/cli/>`, and then labels are required for ALL records. In
...
the model will then be based on these decisions and used to predict relevance
...
green during screening. This option is useful for training purposes or for
during presentations or workshops.
